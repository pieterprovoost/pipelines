...
public class ExtensionInterpretationTest {
  ...
  public void interpretationTest() {
    ...
    ExtendedRecord erSource = ExtendedRecord.newBuilder()
        .setId("id")
    ...
    BiFunction<EiTest, String, List<String>> val2Fn = (eiTest, s) -> {
      eiTest.val2 = s;
      return Collections.emptyList();
    };
    BiFunction<EiTest, String, List<String>> val3Fn = (eiTest, s) -> {
      eiTest.val3 = s;
      return Collections.singletonList("single");
    };
    BiFunction<EiTest, String, List<String>> val4Fn = (eiTest, s) -> {
      eiTest.val4 = s;
      return Collections.singletonList("multi");
    };
    BiFunction<EiTest, String, String> val5Fn = (eiTest, s) -> {
      eiTest.val5 = s;
      return "multi";
    };
    BiFunction<EiTest, String, String> val6Fn = (eiTest, s) -> {
      eiTest.val6 = s;
      return "multi";
    };
    Consumer<EiTest> postFn1 = eiTest -> eiTest.val1 = eiTest.val1 + eiTest.val2 + eiTest.val3;
    Function<EiTest, List<String>> postFn2 = eiTest -> {
      eiTest.val2 = eiTest.val1 + eiTest.val3;
      return Collections.singletonList("single");
    };
    Function<EiTest, String> postFn3 = eiTest -> {
      eiTest.val5 += "+";
      return "";
    };
    Function<EiTest, Optional<String>> checker = eit -> {
    ...
    TargetHandler<EiTest> handler = ExtensionInterpretation.extension("mmm")
        .to(EiTest::new)
        .map("val1", val1Fn)
